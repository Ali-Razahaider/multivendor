const styles = {
  ...
  heading:
    "text-[27px] text-center md:text-start font-semibold font-Roboto pb-5",
  ...
  price: "font-medium text-base text-[#d55b45] pl-3 -mt-1 line-through",
  ...
  cart_button:
    "px-5 h-[38px] rounded-[20px] bg-[#f63b60] flex items-center justify-center cursor-pointer",
  cart_button_text: "text-white text-base font-semibold",
  input: "w-full border p-1 rounded-[5px]",
  activeStatus:
    "size-[10px] rounded-full absolute top-0 right-1 bg-[#40d132]",
